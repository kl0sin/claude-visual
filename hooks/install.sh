...
echo ""
echo -e "${CYAN}Remote / container usage:${NC}"
echo -e "  If Claude Code runs in a container or sandbox, set:"
echo -e "  ${YELLOW}export CLAUDE_VISUAL_URL=http://host.docker.internal:3200${NC}"
echo -e "  (or the URL where the Claude Visual server is reachable)"
echo ""
