...
export async function getHookStatus(): Promise<{ installed: boolean }> {
  try {
    ...
    const installed = hooksStr.includes("/api/events") && (hooksStr.includes("CLAUDE_VISUAL") || hooksStr.includes("localhost:3200"));
    return { installed };
  } catch {
...
const CLAUDE_VISUAL_HOOKS: Record<string, unknown> = {
  SessionStart: [{ hooks: [{ type: "command", command: "INPUT=$(cat) && printf '%s' \"$INPUT\" | jq -c '. + {event_type: \"SessionStart\", session_id: (.session_id // env.CLAUDE_SESSION_ID)}' | curl -s -X POST -H 'Content-Type: application/json' -d @- ${CLAUDE_VISUAL_URL:-http://localhost:3200}/api/events > /dev/null 2>&1 ; printf '%s' \"$INPUT\" | jq -c '. + {event_type: \"SubagentStart\", agent_type: \"session\", session_id: (.session_id // env.CLAUDE_SESSION_ID)}' | curl -s -X POST -H 'Content-Type: application/json' -d @- ${CLAUDE_VISUAL_URL:-http://localhost:3200}/api/events > /dev/null 2>&1" }] }],
  SessionEnd: [{ hooks: [{ type: "command", command: "INPUT=$(cat) && printf '%s' \"$INPUT\" | jq -c '. + {event_type: \"SessionEnd\", session_id: (.session_id // env.CLAUDE_SESSION_ID)}' | curl -s -X POST -H 'Content-Type: application/json' -d @- ${CLAUDE_VISUAL_URL:-http://localhost:3200}/api/events > /dev/null 2>&1" }] }],
  UserPromptSubmit: [{ hooks: [{ type: "command", command: "INPUT=$(cat) && printf '%s' \"$INPUT\" | jq -c '. + {event_type: \"UserPromptSubmit\", session_id: (.session_id // env.CLAUDE_SESSION_ID)}' | curl -s -X POST -H 'Content-Type: application/json' -d @- ${CLAUDE_VISUAL_URL:-http://localhost:3200}/api/events > /dev/null 2>&1" }] }],
  PreToolUse: [{ hooks: [{ type: "command", command: "INPUT=$(cat) && printf '%s' \"$INPUT\" | jq -c '. + {event_type: \"PreToolUse\", session_id: (.session_id // env.CLAUDE_SESSION_ID)}' | curl -s -X POST -H 'Content-Type: application/json' -d @- ${CLAUDE_VISUAL_URL:-http://localhost:3200}/api/events > /dev/null 2>&1" }] }],
  PostToolUse: [{ hooks: [{ type: "command", command: "INPUT=$(cat) && printf '%s' \"$INPUT\" | jq -c '. + {event_type: \"PostToolUse\", session_id: (.session_id // env.CLAUDE_SESSION_ID)}' | curl -s -X POST -H 'Content-Type: application/json' -d @- ${CLAUDE_VISUAL_URL:-http://localhost:3200}/api/events > /dev/null 2>&1" }] }],
  PostToolUseFailure: [{ hooks: [{ type: "command", command: "INPUT=$(cat) && printf '%s' \"$INPUT\" | jq -c '. + {event_type: \"PostToolUseFailure\", session_id: (.session_id // env.CLAUDE_SESSION_ID)}' | curl -s -X POST -H 'Content-Type: application/json' -d @- ${CLAUDE_VISUAL_URL:-http://localhost:3200}/api/events > /dev/null 2>&1" }] }],
  SubagentStart: [{ hooks: [{ type: "command", command: "INPUT=$(cat) && printf '%s' \"$INPUT\" | jq -c '. + {event_type: \"SubagentStart\", session_id: (.session_id // env.CLAUDE_SESSION_ID)}' | curl -s -X POST -H 'Content-Type: application/json' -d @- ${CLAUDE_VISUAL_URL:-http://localhost:3200}/api/events > /dev/null 2>&1" }] }],
  SubagentStop: [{ hooks: [{ type: "command", command: "INPUT=$(cat) && printf '%s' \"$INPUT\" | jq -c '. + {event_type: \"SubagentStop\", session_id: (.session_id // env.CLAUDE_SESSION_ID)}' | curl -s -X POST -H 'Content-Type: application/json' -d @- ${CLAUDE_VISUAL_URL:-http://localhost:3200}/api/events > /dev/null 2>&1" }] }],
  Stop: [{ hooks: [{ type: "command", command: "INPUT=$(cat) && printf '%s' \"$INPUT\" | jq -c '. + {event_type: \"Stop\", session_id: (.session_id // env.CLAUDE_SESSION_ID)}' | curl -s -X POST -H 'Content-Type: application/json' -d @- ${CLAUDE_VISUAL_URL:-http://localhost:3200}/api/events > /dev/null 2>&1" }] }],
  StopFailure: [{ hooks: [{ type: "command", command: "INPUT=$(cat) && printf '%s' \"$INPUT\" | jq -c '. + {event_type: \"StopFailure\", session_id: (.session_id // env.CLAUDE_SESSION_ID)}' | curl -s -X POST -H 'Content-Type: application/json' -d @- ${CLAUDE_VISUAL_URL:-http://localhost:3200}/api/events > /dev/null 2>&1" }] }],
  Notification: [{ hooks: [{ type: "command", command: "INPUT=$(cat) && printf '%s' \"$INPUT\" | jq -c '. + {event_type: \"Notification\", session_id: (.session_id // env.CLAUDE_SESSION_ID)}' | curl -s -X POST -H 'Content-Type: application/json' -d @- ${CLAUDE_VISUAL_URL:-http://localhost:3200}/api/events > /dev/null 2>&1" }] }],
  TaskCreated: [{ hooks: [{ type: "command", command: "INPUT=$(cat) && printf '%s' \"$INPUT\" | jq -c '. + {event_type: \"TaskCreated\", session_id: (.session_id // env.CLAUDE_SESSION_ID)}' | curl -s -X POST -H 'Content-Type: application/json' -d @- ${CLAUDE_VISUAL_URL:-http://localhost:3200}/api/events > /dev/null 2>&1" }] }],
  TaskCompleted: [{ hooks: [{ type: "command", command: "INPUT=$(cat) && printf '%s' \"$INPUT\" | jq -c '. + {event_type: \"TaskCompleted\", session_id: (.session_id // env.CLAUDE_SESSION_ID)}' | curl -s -X POST -H 'Content-Type: application/json' -d @- ${CLAUDE_VISUAL_URL:-http://localhost:3200}/api/events > /dev/null 2>&1" }] }],
  InstructionsLoaded: [{ hooks: [{ type: "command", command: "INPUT=$(cat) && printf '%s' \"$INPUT\" | jq -c '. + {event_type: \"InstructionsLoaded\", session_id: (.session_id // env.CLAUDE_SESSION_ID)}' | curl -s -X POST -H 'Content-Type: application/json' -d @- ${CLAUDE_VISUAL_URL:-http://localhost:3200}/api/events > /dev/null 2>&1" }] }],
  PermissionRequest: [{ hooks: [{ type: "command", command: "INPUT=$(cat) && printf '%s' \"$INPUT\" | jq -c '. + {event_type: \"PermissionRequest\", session_id: (.session_id // env.CLAUDE_SESSION_ID)}' | curl -s -X POST -H 'Content-Type: application/json' -d @- ${CLAUDE_VISUAL_URL:-http://localhost:3200}/api/events > /dev/null 2>&1" }] }],
  PermissionDenied: [{ hooks: [{ type: "command", command: "INPUT=$(cat) && printf '%s' \"$INPUT\" | jq -c '. + {event_type: \"PermissionDenied\", session_id: (.session_id // env.CLAUDE_SESSION_ID)}' | curl -s -X POST -H 'Content-Type: application/json' -d @- ${CLAUDE_VISUAL_URL:-http://localhost:3200}/api/events > /dev/null 2>&1" }] }],
  TeammateIdle: [{ hooks: [{ type: "command", command: "INPUT=$(cat) && printf '%s' \"$INPUT\" | jq -c '. + {event_type: \"TeammateIdle\", session_id: (.session_id // env.CLAUDE_SESSION_ID)}' | curl -s -X POST -H 'Content-Type: application/json' -d @- ${CLAUDE_VISUAL_URL:-http://localhost:3200}/api/events > /dev/null 2>&1" }] }],
  FileChanged: [{ hooks: [{ type: "command", command: "INPUT=$(cat) && printf '%s' \"$INPUT\" | jq -c '. + {event_type: \"FileChanged\", session_id: (.session_id // env.CLAUDE_SESSION_ID)}' | curl -s -X POST -H 'Content-Type: application/json' -d @- ${CLAUDE_VISUAL_URL:-http://localhost:3200}/api/events > /dev/null 2>&1" }] }],
  CwdChanged: [{ hooks: [{ type: "command", command: "INPUT=$(cat) && printf '%s' \"$INPUT\" | jq -c '. + {event_type: \"CwdChanged\", session_id: (.session_id // env.CLAUDE_SESSION_ID)}' | curl -s -X POST -H 'Content-Type: application/json' -d @- ${CLAUDE_VISUAL_URL:-http://localhost:3200}/api/events > /dev/null 2>&1" }] }],
  ConfigChange: [{ hooks: [{ type: "command", command: "INPUT=$(cat) && printf '%s' \"$INPUT\" | jq -c '. + {event_type: \"ConfigChange\", session_id: (.session_id // env.CLAUDE_SESSION_ID)}' | curl -s -X POST -H 'Content-Type: application/json' -d @- ${CLAUDE_VISUAL_URL:-http://localhost:3200}/api/events > /dev/null 2>&1" }] }],
  WorktreeCreate: [{ hooks: [{ type: "command", command: "INPUT=$(cat) && printf '%s' \"$INPUT\" | jq -c '. + {event_type: \"WorktreeCreate\", session_id: (.session_id // env.CLAUDE_SESSION_ID)}' | curl -s -X POST -H 'Content-Type: application/json' -d @- ${CLAUDE_VISUAL_URL:-http://localhost:3200}/api/events > /dev/null 2>&1" }] }],
  WorktreeRemove: [{ hooks: [{ type: "command", command: "INPUT=$(cat) && printf '%s' \"$INPUT\" | jq -c '. + {event_type: \"WorktreeRemove\", session_id: (.session_id // env.CLAUDE_SESSION_ID)}' | curl -s -X POST -H 'Content-Type: application/json' -d @- ${CLAUDE_VISUAL_URL:-http://localhost:3200}/api/events > /dev/null 2>&1" }] }],
  PreCompact: [{ hooks: [{ type: "command", command: "INPUT=$(cat) && printf '%s' \"$INPUT\" | jq -c '. + {event_type: \"PreCompact\", session_id: (.session_id // env.CLAUDE_SESSION_ID)}' | curl -s -X POST -H 'Content-Type: application/json' -d @- ${CLAUDE_VISUAL_URL:-http://localhost:3200}/api/events > /dev/null 2>&1" }] }],
  PostCompact: [{ hooks: [{ type: "command", command: "INPUT=$(cat) && printf '%s' \"$INPUT\" | jq -c '. + {event_type: \"PostCompact\", session_id: (.session_id // env.CLAUDE_SESSION_ID)}' | curl -s -X POST -H 'Content-Type: application/json' -d @- ${CLAUDE_VISUAL_URL:-http://localhost:3200}/api/events > /dev/null 2>&1" }] }],
  Elicitation: [{ hooks: [{ type: "command", command: "INPUT=$(cat) && printf '%s' \"$INPUT\" | jq -c '. + {event_type: \"Elicitation\", session_id: (.session_id // env.CLAUDE_SESSION_ID)}' | curl -s -X POST -H 'Content-Type: application/json' -d @- ${CLAUDE_VISUAL_URL:-http://localhost:3200}/api/events > /dev/null 2>&1" }] }],
  ElicitationResult: [{ hooks: [{ type: "command", command: "INPUT=$(cat) && printf '%s' \"$INPUT\" | jq -c '. + {event_type: \"ElicitationResult\", session_id: (.session_id // env.CLAUDE_SESSION_ID)}' | curl -s -X POST -H 'Content-Type: application/json' -d @- ${CLAUDE_VISUAL_URL:-http://localhost:3200}/api/events > /dev/null 2>&1" }] }],
};
